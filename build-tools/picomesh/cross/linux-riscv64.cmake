# CMake toolchain for cross-compiling picomesh from host x86_64 to
# linux-riscv64. Mirrors yetty's CMAKE_CROSS_RISCV setup.
#
# Usage:
#   cmake -B build-linux-riscv64-release \
#         -DCMAKE_TOOLCHAIN_FILE=build-tools/picomesh/cross/linux-riscv64.cmake \
#         -DCMAKE_BUILD_TYPE=Release
#
# Host setup (Ubuntu 24.04 / Debian 12):
#   sudo apt-get install -y gcc-riscv64-linux-gnu g++-riscv64-linux-gnu
#
# Output: a static-linked picomesh binary that runs inside the riscv64
