...
# lib{ssl,crypto}.a on POSIX, lib{ssl,crypto}.lib on MSVC.
set(_OSSL_SSL "")
set(_OSSL_CRYPTO "")
foreach(_CAND libssl.a libssl.lib)
    if(EXISTS "${_OSSL_DIR}/lib/${_CAND}")
        set(_OSSL_SSL "${_OSSL_DIR}/lib/${_CAND}")
        break()
    endif()
endforeach()
foreach(_CAND libcrypto.a libcrypto.lib)
    if(EXISTS "${_OSSL_DIR}/lib/${_CAND}")
        set(_OSSL_CRYPTO "${_OSSL_DIR}/lib/${_CAND}")
        break()
    endif()
endforeach()
if(NOT _OSSL_SSL OR NOT _OSSL_CRYPTO)
    message(FATAL_ERROR "openssl: lib{ssl,crypto}.a/.lib missing under ${_OSSL_DIR}/lib")
endif()
