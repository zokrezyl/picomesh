        ...
        if(NOT EXISTS "${_TARBALL}")
            ...
            if(NOT PICOMESH_3RDPARTY_FORCE_BUILD)
                ...
                if(_DL_CODE EQUAL 0)
                    ...
                    # CMake's bundled libcurl ships without a CA bundle on
                    # Windows, so a verified HTTPS pull fails with "peer
                    # certificate cannot be authenticated" unless CMAKE_TLS_CAINFO
                    # points at a cacert.pem — build-tools/windows/build.bat sets
                    # that from Strawberry Perl's bundle. With the CA wired up the
                    # download verifies normally on every platform.
                    message(STATUS
