...
#ifndef PICOMESH_YCONFIG_YCONFIG_H
#define PICOMESH_YCONFIG_YCONFIG_H
...
PICOMESH_RESULT_DECLARE(yconfig_ptr, struct yconfig *);
PICOMESH_RESULT_DECLARE(yconfig_node_ptr, const struct yconfig_node *);
 ...
 * flow text — the same emitter `yconfig_dump` uses for the whole tree.
...
#endif /* PICOMESH_YCONFIG_YCONFIG_H */
