/* picomesh/yco/coro.h - Coroutine primitive.
 *
 ...
 *
 * Every fallible entry returns a Result (see <picomesh/ycore/result.h>). */

#ifndef PICOMESH_YCO_CORO_H
#define PICOMESH_YCO_CORO_H
