 ...
 * <picomesh/ycore/result.h>. Callers check PICOMESH_IS_ERR and either
 * propagate (PICOMESH_RETURN_IF_ERR) or absorb at a boundary. */

#ifndef PICOMESH_YCLASS_CLASS_H
#define PICOMESH_YCLASS_CLASS_H
 ...
 *
 * The codegen (src/picomesh/yclass/gen/codegen.py) reads the literal
 ...
 * mixed into this struct. See <picomesh/yclass/yheaders.h>. */
struct ctx {
