 ...
 *
 * The RECEIVER is the `trace_collector` plugin (annotated yclass methods
 ...
 *   - yspan (ycore/yspan.h) — a process-local latency aggregate
 *     (/_perf). ytelemetry_span_end still feeds it.
 *   - ydebug (ycore/ytrace.h) — gated line logging. */

#ifndef PICOMESH_YCORE_YTELEMETRY_H
#define PICOMESH_YCORE_YTELEMETRY_H
...
#endif /* PICOMESH_YCORE_YTELEMETRY_H */
