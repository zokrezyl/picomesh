...
#ifndef YAAFC_FRONTENDS_YTTP_YTTP_H
#define YAAFC_FRONTENDS_YTTP_YTTP_H
...
YAAFC_RESULT_DECLARE(yttp_frontend_ptr, struct yttp_frontend *);
...
#endif /* YAAFC_FRONTENDS_YTTP_YTTP_H */
