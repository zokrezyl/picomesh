 ...
 * live under src/yaafc/yplatform/time/<platform>.c — CMake selects
...
#ifndef YAAFC_YPLATFORM_TIME_H
#define YAAFC_YPLATFORM_TIME_H
...
double yaafc_yplatform_time_monotonic_sec(void);

/* Wall-clock time in milliseconds since the Unix epoch. */
int64_t yaafc_yplatform_time_wall_ms(void);
...
void yaafc_yplatform_time_sleep_ms(unsigned ms);

#ifdef __cplusplus
}
#endif

#endif /* YAAFC_YPLATFORM_TIME_H */
