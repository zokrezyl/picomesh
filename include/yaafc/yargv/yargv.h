 ...
 *
 *   yaafc [--global-options...] <subcommand> [<sub-args>...]
 *
...
#ifndef YAAFC_YARGV_YARGV_H
#define YAAFC_YARGV_YARGV_H
...
YAAFC_RESULT_DECLARE(yargv_chain_ptr, struct yargv_chain *);
