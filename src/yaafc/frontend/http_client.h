/* Outgoing HTTP client for the standalone frontend.
 * NOT installed; internal to src/yaafc/frontend/. */
#ifndef YAAFC_FRONTEND_HTTP_CLIENT_H
#define YAAFC_FRONTEND_HTTP_CLIENT_H
