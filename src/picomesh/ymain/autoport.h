...
#ifndef PICOMESH_YMAIN_AUTOPORT_H
#define PICOMESH_YMAIN_AUTOPORT_H
...
int picomesh_autoport_allocate(struct picomesh_engine *engine, const char *name,
                               const char *host);
...
#endif /* PICOMESH_YMAIN_AUTOPORT_H */
