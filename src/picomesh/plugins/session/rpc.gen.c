...
session_session_start_skel(const void *_body, size_t _body_len, void *_resp,
                           size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  ...
  struct picomesh_string_result _r =
      session_session_start(&_local, _obj, _hdrs, _v1, _s2, _s3);
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size, "session_session_start_skel: response buffer too small");
  ...
  }
  {
    ...
    if (_resp_max < 1 + 4 + (size_t)_svlen) {
      ...
      return PICOMESH_ERR(
          picomesh_size,
          "session_session_start_skel: response buffer too small");
    }
    ((uint8_t *)_resp)[0] = 0;
...
static struct picomesh_size_result session_session_jwt_skel(const void *_body,
                                                            size_t _body_len,
                                                            void *_resp,
                                                            size_t _resp_max) {
  size_t _off = 0;
  ...
  struct picomesh_string_result _r =
      session_session_jwt(&_local, _obj, _hdrs, _s1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "session_session_jwt_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
  ...
  }
  {
    ...
    if (_resp_max < 1 + 4 + (size_t)_svlen) {
      free(_r.value);
      return PICOMESH_ERR(
          picomesh_size, "session_session_jwt_skel: response buffer too small");
    }
    ((uint8_t *)_resp)[0] = 0;
    memcpy((uint8_t *)_resp + 1, &_svlen, 4);
    if (_svlen)
...
static struct picomesh_size_result
session_session_lookup_skel(const void *_body, size_t _body_len, void *_resp,
                            size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_uint32_result _r =
      session_session_lookup(&_local, _obj, _hdrs, _s1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "session_session_lookup_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
session_session_destroy_skel(const void *_body, size_t _body_len, void *_resp,
                             size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_int_result _r =
      session_session_destroy(&_local, _obj, _hdrs, _s1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "session_session_destroy_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
session_session_count_active_skel(const void *_body, size_t _body_len,
  ...
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.session_session_count_active");
  struct picomesh_size_result _r =
      session_session_count_active(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "session_session_count_active_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result session_session_list_skel(const void *_body,
                                                             size_t _body_len,
                                                             void *_resp,
                                                             size_t _resp_max) {
  size_t _off = 0;
  ...
  struct picomesh_json_result _r =
      session_session_list(&_local, _obj, _hdrs, _v1, _v2);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "session_session_list_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
session_session_list_all_skel(const void *_body, size_t _body_len, void *_resp,
                              size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_json_result _r =
      session_session_list_all(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "session_session_list_all_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_void_result session_session_start_jinvoke(
  ...
  struct picomesh_string_result call_result =
      session_session_start(call_ctx, obj, hdrs, arg0, arg1, arg2);
...
static struct picomesh_void_result session_session_jwt_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      session_session_jwt(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_lookup_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_uint32_result call_result =
      session_session_lookup(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_destroy_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_int_result call_result =
      session_session_destroy(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_count_active_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_size_result call_result =
      session_session_count_active(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "session_session_count_active",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "session_session_count_active",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result session_session_list_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_json_result call_result =
      session_session_list(call_ctx, obj, hdrs, arg0, arg1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_list_all_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
      session_session_list_all(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_start_minvoke(
  ...
  (void)_mr;
  if (_argc != 3u) {
    snprintf(_err, _err_cap, "session_session_start: expected 3 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "session_session_start: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  char _v1[4096];
  {
    ...
    if (!cmp_read_str(_mr, _v1, &_sz)) {
      snprintf(_err, _err_cap, "access_jwt: expected str arg (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
  }
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      session_session_start(call_ctx, obj, hdrs, _v0, _v1, _v2);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_jwt_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap, "session_session_jwt: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "session_session_jwt: wrong argument count");
  }
  char _v0[4096];
  {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      session_session_jwt(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_lookup_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "session_session_lookup: expected 1 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "session_session_lookup: wrong argument count");
  }
  char _v0[4096];
  {
    uint32_t _sz = (uint32_t)sizeof(_v0);
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_uint32_result call_result =
      session_session_lookup(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_destroy_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "session_session_destroy: expected 1 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "session_session_destroy: wrong argument count");
  }
  char _v0[4096];
  {
    uint32_t _sz = (uint32_t)sizeof(_v0);
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      session_session_destroy(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_count_active_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "session_session_count_active: expected 0 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "session_session_count_active: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
...
static struct picomesh_void_result session_session_list_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 2u) {
    snprintf(_err, _err_cap, "session_session_list: expected 2 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "session_session_list: wrong argument count");
  }
  int64_t _v0;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
      session_session_list(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result session_session_list_all_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "session_session_list_all: expected 0 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "session_session_list_all: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
...
struct object_ptr_result session_session_create(struct ctx *ctx) {
  ...
  if (PICOMESH_IS_ERR(_kr))
    return PICOMESH_ERR(object_ptr,
                        "session_session_create: class accessor failed", _kr);
...
static struct class_ptr_result session_accessor_lookup(const char *name) {
  if (strcmp(name, "session_session") == 0)
    return session_session_class_get();
  return PICOMESH_OK(class_ptr, NULL);
}

/* ---- session: slot → skel, name-keyed static data --------------- */

struct session_skel_row {
  const char *name;
  rpc_skel_fn fn;
};
...
static rpc_skel_fn session_skel_lookup(const char *name) {
  ...
  for (size_t i = 0;
       i < sizeof(session_skel_rows) / sizeof(session_skel_rows[0]); ++i)
...
struct picomesh_void_result picomesh_plugin_session_register(void) {
  struct picomesh_void_result _ar =
      class_add_accessor_lookup(session_accessor_lookup);
  ...
  jinvoke_params_add_lookup(session_params_lookup);
  {
    ...
    PICOMESH_RETURN_IF_ERR(
        picomesh_void, reg,
        "session register: prewarm session_session_class_get");
  }
  return PICOMESH_OK_VOID();
}
