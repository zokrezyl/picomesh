...
struct PICOMESH_CLASS_ANNOTATE("class@github_authn:store") github_authn_store_data {
    uint32_t client_id;
...
PICOMESH_CLASS_ANNOTATE("override@github_authn:store:store_set_credentials")
struct picomesh_int_result github_authn_store_set_credentials_impl(struct ctx *ctx,
                                                                struct object *obj,
...
PICOMESH_CLASS_ANNOTATE("override@github_authn:store:store_register_code")
struct picomesh_int_result github_authn_store_register_code_impl(struct ctx *ctx,
                                                              struct object *obj,
                                                              struct yheaders *hdrs,
...
PICOMESH_CLASS_ANNOTATE("override@github_authn:store:store_resolve")
struct picomesh_uint32_result github_authn_store_resolve_impl(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                                                           uint32_t code)
{
    (void)ctx;
    struct github_authn_store_data *d = gh(obj);
...
PICOMESH_CLASS_ANNOTATE("override@github_authn:store:store_count_codes")
struct picomesh_size_result github_authn_store_count_codes_impl(struct ctx *ctx, struct object *obj, struct yheaders *hdrs)
{
    (void)ctx;
