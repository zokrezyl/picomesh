...
static struct picomesh_size_result storage_set_skel(const void *_body,
                                                    size_t _body_len,
                                                    void *_resp,
                                                    size_t _resp_max) {
  size_t _off = 0;
  ...
  struct picomesh_int_result _r =
      storage_set(&_local, _obj, _hdrs, _s1, _s2, _s3);
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "storage_set_skel: response buffer too small");
...
static struct picomesh_size_result storage_get_skel(const void *_body,
                                                    size_t _body_len,
                                                    void *_resp,
                                                    size_t _resp_max) {
  size_t _off = 0;
  ...
  struct picomesh_string_result _r =
      storage_get(&_local, _obj, _hdrs, _s1, _s2);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "storage_get_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result storage_exists_skel(const void *_body,
                                                       size_t _body_len,
                                                       void *_resp,
                                                       size_t _resp_max) {
  size_t _off = 0;
  ...
  struct picomesh_int_result _r =
      storage_exists(&_local, _obj, _hdrs, _s1, _s2);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "storage_exists_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result storage_del_skel(const void *_body,
                                                    size_t _body_len,
                                                    void *_resp,
                                                    size_t _resp_max) {
  size_t _off = 0;
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "storage_del_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result storage_count_skel(const void *_body,
                                                      size_t _body_len,
                                                      void *_resp,
                                                      size_t _resp_max) {
  size_t _off = 0;
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "storage_count_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
storage_set_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                    const struct json_value *args, struct json_writer *result,
  ...
  struct picomesh_int_result call_result =
      storage_set(call_ctx, obj, hdrs, arg0, arg1, arg2);
...
static struct picomesh_void_result
storage_get_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                    const struct json_value *args, struct json_writer *result,
                    char *err, size_t err_cap) {
  ...
  struct picomesh_string_result call_result =
      storage_get(call_ctx, obj, hdrs, arg0, arg1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_exists_jinvoke(struct ctx *ctx, struct object *obj,
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      storage_exists(call_ctx, obj, hdrs, arg0, arg1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_del_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                    const struct json_value *args, struct json_writer *result,
                    char *err, size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      storage_del(call_ctx, obj, hdrs, arg0, arg1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_count_jinvoke(struct ctx *ctx, struct object *obj,
                      struct yheaders *hdrs, const struct json_value *args,
                      struct json_writer *result, char *err, size_t err_cap) {
  ...
  struct picomesh_size_result call_result =
      storage_count(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_set_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                    cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw, char *_err,
                    size_t _err_cap) {
  (void)_mr;
  if (_argc != 3u) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      storage_set(call_ctx, obj, hdrs, _v0, _v1, _v2);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_get_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                    cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw, char *_err,
                    size_t _err_cap) {
  (void)_mr;
  if (_argc != 2u) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      storage_get(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_exists_minvoke(struct ctx *ctx, struct object *obj,
                       struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                       cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 2u) {
    snprintf(_err, _err_cap, "storage_exists: expected 2 arg(s), got %u",
             _argc);
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      storage_exists(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_del_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                    cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw, char *_err,
                    size_t _err_cap) {
  (void)_mr;
  if (_argc != 2u) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      storage_del(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
storage_count_minvoke(struct ctx *ctx, struct object *obj,
                      struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                      cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
      storage_count(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
struct object_ptr_result storage_db_create(struct ctx *ctx) {
  ...
  if (PICOMESH_IS_ERR(_kr))
    return PICOMESH_ERR(object_ptr, "storage_db_create: class accessor failed",
                        _kr);
...
static struct class_ptr_result storage_accessor_lookup(const char *name) {
  if (strcmp(name, "storage_db") == 0)
    return storage_db_class_get();
  return PICOMESH_OK(class_ptr, NULL);
}

/* ---- storage: slot → skel, name-keyed static data --------------- */

struct storage_skel_row {
  const char *name;
  rpc_skel_fn fn;
};
...
static rpc_skel_fn storage_skel_lookup(const char *name) {
  ...
  for (size_t i = 0;
       i < sizeof(storage_skel_rows) / sizeof(storage_skel_rows[0]); ++i)
...
struct picomesh_void_result picomesh_plugin_storage_register(void) {
  struct picomesh_void_result _ar =
      class_add_accessor_lookup(storage_accessor_lookup);
  ...
  jinvoke_params_add_lookup(storage_params_lookup);
  {
    ...
    PICOMESH_RETURN_IF_ERR(picomesh_void, reg,
                           "storage register: prewarm storage_db_class_get");
  }
  return PICOMESH_OK_VOID();
}
