...
struct picomesh_int_result storage_set(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, const char * context, const char * key, const char * value)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "storage_set: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_string_result storage_get(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, const char * context, const char * key)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_string, _msg[0] ? strdup(_msg) : "storage_get: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result storage_exists(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, const char * context, const char * key)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "storage_exists: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result storage_del(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, const char * context, const char * key)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "storage_del: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_size_result storage_count(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, const char * context)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_size, _msg[0] ? strdup(_msg) : "storage_count: remote error (no msg)");
            goto _rpc_done;
        }
