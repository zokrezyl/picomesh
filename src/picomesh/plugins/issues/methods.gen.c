...
struct picomesh_uint32_result issues_issues_open(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t repo_id, uint32_t author_id)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_uint32, _msg[0] ? strdup(_msg) : "issues_issues_open: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result issues_issues_close(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t issue_id)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "issues_issues_close: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result issues_issues_status(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t issue_id)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "issues_issues_status: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_size_result issues_issues_count_open_in_repo(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t repo_id)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_size, _msg[0] ? strdup(_msg) : "issues_issues_count_open_in_repo: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_size_result issues_issues_count_total(struct ctx * ctx, struct object * obj, struct yheaders * hdrs)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_size, _msg[0] ? strdup(_msg) : "issues_issues_count_total: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_json_result issues_issues_list(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, int64_t offset, int64_t limit)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_json, _msg[0] ? strdup(_msg) : "issues_issues_list: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_json_result issues_issues_list_all(struct ctx * ctx, struct object * obj, struct yheaders * hdrs)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_json, _msg[0] ? strdup(_msg) : "issues_issues_list_all: remote error (no msg)");
            goto _rpc_done;
        }
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.repo_of", hdrs,
                                           _margs, _mab.offset, _mresp, 256,
                                           &_mrlen, _merr, sizeof(_merr))) {
                _mret = PICOMESH_ERR(picomesh_uint32, _merr[0] ? strdup(_merr) : "issues_issues_repo_of: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_uint32, _msg[0] ? strdup(_msg) : "issues_issues_repo_of: remote error (no msg)");
            goto _rpc_done;
        }
