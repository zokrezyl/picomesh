...
__attribute__((unused))
static mesh_store_spawn_picomesh_fn _mesh_store_mesh_store_spawn_picomesh_check = mesh_store_spawn_picomesh_impl;
__attribute__((unused))
...
struct class_ptr_result mesh_store_class_get(void)
{
    ...
    static const struct op ops[] = {
        ...
        {"mesh", "store_spawn_picomesh", (method_id_t)mesh_store_spawn_picomesh, (impl_t)mesh_store_spawn_picomesh_impl},
    ...
    if (PICOMESH_IS_ERR(_r))
        return PICOMESH_ERR(class_ptr, "mesh_store_class_get: class_register failed", _r);
    cls = _r.value;
    return _r;
}
