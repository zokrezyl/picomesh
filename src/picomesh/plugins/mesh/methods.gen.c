...
struct picomesh_int_result mesh_mesh_register_service(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t service_id, uint32_t port)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "mesh_mesh_register_service: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_uint32_result mesh_mesh_resolve(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t service_id)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_uint32, _msg[0] ? strdup(_msg) : "mesh_mesh_resolve: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result mesh_mesh_forget(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t service_id)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "mesh_mesh_forget: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_size_result mesh_mesh_count_services(struct ctx * ctx, struct object * obj, struct yheaders * hdrs)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_size, _msg[0] ? strdup(_msg) : "mesh_mesh_count_services: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result mesh_mesh_spawn_picomesh(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t port)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "mesh_mesh_spawn_picomesh: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result mesh_mesh_kill_pid(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, int32_t pid)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "mesh_mesh_kill_pid: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_size_result mesh_mesh_count_children(struct ctx * ctx, struct object * obj, struct yheaders * hdrs)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_size, _msg[0] ? strdup(_msg) : "mesh_mesh_count_children: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result mesh_mesh_reconcile_from_config(struct ctx * ctx, struct object * obj, struct yheaders * hdrs)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "mesh_mesh_reconcile_from_config: remote error (no msg)");
            goto _rpc_done;
        }
...
struct picomesh_int_result mesh_mesh_reconcile(struct ctx * ctx, struct object * obj, struct yheaders * hdrs)
{
    ...
    if (_s && _s->peer) {
        ...
        if (_wbuf[0] != 0) {
            ...
            if (_wn >= 5 + _copy) memcpy(_msg, _wbuf + 5, _copy);
            _msg[_copy] = 0;
            _ret = PICOMESH_ERR(picomesh_int, _msg[0] ? strdup(_msg) : "mesh_mesh_reconcile: remote error (no msg)");
            goto _rpc_done;
        }
