...
mesh_mesh_register_service_skel(const void *_body, size_t _body_len,
  ...
  struct picomesh_int_result _r =
      mesh_mesh_register_service(&_local, _obj, _hdrs, _v1, _v2);
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "mesh_mesh_register_service_skel: response buffer too small");
...
static struct picomesh_size_result mesh_mesh_resolve_skel(const void *_body,
                                                          size_t _body_len,
                                                          void *_resp,
                                                          size_t _resp_max) {
  size_t _off = 0;
  ...
  struct picomesh_uint32_result _r =
      mesh_mesh_resolve(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "mesh_mesh_resolve_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result mesh_mesh_forget_skel(const void *_body,
                                                         size_t _body_len,
                                                         void *_resp,
                                                         size_t _resp_max) {
  size_t _off = 0;
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "mesh_mesh_forget_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
mesh_mesh_count_services_skel(const void *_body, size_t _body_len, void *_resp,
                              size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_size_result _r =
      mesh_mesh_count_services(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "mesh_mesh_count_services_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
mesh_mesh_spawn_picomesh_skel(const void *_body, size_t _body_len, void *_resp,
                              size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_int_result _r =
      mesh_mesh_spawn_picomesh(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "mesh_mesh_spawn_picomesh_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result mesh_mesh_kill_pid_skel(const void *_body,
                                                           size_t _body_len,
                                                           void *_resp,
                                                           size_t _resp_max) {
  size_t _off = 0;
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "mesh_mesh_kill_pid_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
mesh_mesh_count_children_skel(const void *_body, size_t _body_len, void *_resp,
                              size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_size_result _r =
      mesh_mesh_count_children(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "mesh_mesh_count_children_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
mesh_mesh_reconcile_from_config_skel(const void *_body, size_t _body_len,
                                     void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.mesh_mesh_reconcile_from_config");
  struct picomesh_int_result _r =
      mesh_mesh_reconcile_from_config(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "mesh_mesh_reconcile_from_config_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result mesh_mesh_reconcile_skel(const void *_body,
                                                            size_t _body_len,
                                                            void *_resp,
                                                            size_t _resp_max) {
  size_t _off = 0;
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size,
                        "mesh_mesh_reconcile_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_void_result mesh_mesh_register_service_jinvoke(
  ...
  struct picomesh_int_result call_result =
      mesh_mesh_register_service(call_ctx, obj, hdrs, arg0, arg1);
    ...
    snprintf(err, err_cap, "%s: %s", "mesh_mesh_register_service",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "mesh_mesh_register_service",
                        call_result);
  }
...
mesh_mesh_resolve_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err,
                          size_t err_cap) {
  ...
  struct picomesh_uint32_result call_result =
      mesh_mesh_resolve(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
mesh_mesh_forget_jinvoke(struct ctx *ctx, struct object *obj,
                         struct yheaders *hdrs, const struct json_value *args,
                         struct json_writer *result, char *err,
                         size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_forget(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_count_services_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_size_result call_result =
      mesh_mesh_count_services(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_spawn_picomesh_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_spawn_picomesh(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
mesh_mesh_kill_pid_jinvoke(struct ctx *ctx, struct object *obj,
                           struct yheaders *hdrs, const struct json_value *args,
                           struct json_writer *result, char *err,
                           size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_kill_pid(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_count_children_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
      mesh_mesh_count_children(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_reconcile_from_config_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_reconcile_from_config(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "mesh_mesh_reconcile_from_config",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "mesh_mesh_reconcile_from_config",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result mesh_mesh_reconcile_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_reconcile(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_register_service_minvoke(
  ...
  if (_argc != 2u) {
    snprintf(_err, _err_cap,
             "mesh_mesh_register_service: expected 2 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_register_service: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
    if (!cmp_read_uinteger(_mr, &_u)) {
      snprintf(_err, _err_cap, "service_id: expected unsigned int (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    if (_u > UINT32_MAX) {
      snprintf(_err, _err_cap,
               "service_id: value %llu out of range for uint32_t",
  ...
  uint32_t _v1;
  {
    uint64_t _u;
    if (!cmp_read_uinteger(_mr, &_u)) {
      snprintf(_err, _err_cap, "port: expected unsigned int (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    if (_u > UINT32_MAX) {
      snprintf(_err, _err_cap, "port: value %llu out of range for uint32_t",
               (unsigned long long)_u);
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    _v1 = (uint32_t)_u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_register_service(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
mesh_mesh_resolve_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap, "mesh_mesh_resolve: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_resolve: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_uint32_result call_result =
      mesh_mesh_resolve(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
mesh_mesh_forget_minvoke(struct ctx *ctx, struct object *obj,
                         struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                         cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap, "mesh_mesh_forget: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_forget: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_forget(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_count_services_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "mesh_mesh_count_services: expected 0 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_count_services: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
...
static struct picomesh_void_result mesh_mesh_spawn_picomesh_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "mesh_mesh_spawn_picomesh: expected 1 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_spawn_picomesh: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_spawn_picomesh(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_kill_pid_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap, "mesh_mesh_kill_pid: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_kill_pid: wrong argument count");
  }
  int32_t _v0;
  {
    int64_t _i;
    if (!cmp_read_integer(_mr, &_i)) {
      snprintf(_err, _err_cap, "pid: expected int (%s)", cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    if (_i < (INT32_MIN) || _i > (INT32_MAX)) {
      snprintf(_err, _err_cap, "pid: value %lld out of range for int32_t",
               (long long)_i);
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    _v0 = (int32_t)_i;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      mesh_mesh_kill_pid(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result mesh_mesh_count_children_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "mesh_mesh_count_children: expected 0 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_count_children: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
...
static struct picomesh_void_result mesh_mesh_reconcile_from_config_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "mesh_mesh_reconcile_from_config: expected 0 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(
        picomesh_void, "mesh_mesh_reconcile_from_config: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
...
static struct picomesh_void_result mesh_mesh_reconcile_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap, "mesh_mesh_reconcile: expected 0 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "mesh_mesh_reconcile: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
...
struct object_ptr_result mesh_mesh_create(struct ctx *ctx) {
  ...
  if (PICOMESH_IS_ERR(_kr))
    return PICOMESH_ERR(object_ptr, "mesh_mesh_create: class accessor failed",
                        _kr);
...
static const struct mesh_jinvoke_row mesh_jinvoke_rows[] = {
    ...
    {"mesh_mesh_reconcile_from_config",
     mesh_mesh_reconcile_from_config_jinvoke},
...
static const struct mesh_minvoke_row mesh_minvoke_rows[] = {
    ...
    {"mesh_mesh_reconcile_from_config",
     mesh_mesh_reconcile_from_config_minvoke},
...
static const struct jinvoke_param mesh_mesh_register_service_params[] = {
    {"service_id", "uint32_t"}, {"port", "uint32_t"}};
...
static const struct jinvoke_params *mesh_params_lookup(const char *qname) {
  for (size_t i = 0; i < sizeof(mesh_params_rows) / sizeof(mesh_params_rows[0]);
       ++i)
...
static struct class_ptr_result mesh_accessor_lookup(const char *name) {
  if (strcmp(name, "mesh_mesh") == 0)
    return mesh_mesh_class_get();
  return PICOMESH_OK(class_ptr, NULL);
}

/* ---- mesh: slot → skel, name-keyed static data --------------- */

struct mesh_skel_row {
  const char *name;
  rpc_skel_fn fn;
};
...
static rpc_skel_fn mesh_skel_lookup(const char *name) {
  ...
  for (size_t i = 0; i < sizeof(mesh_skel_rows) / sizeof(mesh_skel_rows[0]);
       ++i)
...
struct picomesh_void_result picomesh_plugin_mesh_register(void) {
  struct picomesh_void_result _ar =
      class_add_accessor_lookup(mesh_accessor_lookup);
  ...
  jinvoke_params_add_lookup(mesh_params_lookup);
  {
    ...
    PICOMESH_RETURN_IF_ERR(picomesh_void, reg,
                           "mesh register: prewarm mesh_mesh_class_get");
  }
  return PICOMESH_OK_VOID();
}
