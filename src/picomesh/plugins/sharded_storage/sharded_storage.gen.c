...
__attribute__((unused))
static sharded_storage_db_list_fn _sharded_storage_db_sharded_storage_db_list_check = sharded_storage_db_list_impl;
__attribute__((unused))
static sharded_storage_db_list_all_fn _sharded_storage_db_sharded_storage_db_list_all_check = sharded_storage_db_list_all_impl;
__attribute__((unused))
...
struct class_ptr_result sharded_storage_db_class_get(void)
{
    ...
    static const struct op ops[] = {
        ...
        {"sharded_storage", "db_list", (method_id_t)sharded_storage_db_list, (impl_t)sharded_storage_db_list_impl},
        {"sharded_storage", "db_list_all", (method_id_t)sharded_storage_db_list_all, (impl_t)sharded_storage_db_list_all_impl},
    ...
    if (PICOMESH_IS_ERR(_r))
        return PICOMESH_ERR(class_ptr, "sharded_storage_db_class_get: class_register failed", _r);
    cls = _r.value;
    return _r;
}
