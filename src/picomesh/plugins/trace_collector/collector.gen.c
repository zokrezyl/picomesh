...
static trace_collector_trace_collector_ingest_fn _trace_collector_trace_collector_trace_collector_trace_collector_ingest_check = trace_collector_trace_collector_ingest_impl;
__attribute__((unused))
...
__attribute__((unused))
static trace_collector_trace_collector_latency_fn _trace_collector_trace_collector_trace_collector_trace_collector_latency_check = trace_collector_trace_collector_latency_impl;
__attribute__((unused))
static trace_collector_trace_collector_stats_fn _trace_collector_trace_collector_trace_collector_trace_collector_stats_check = trace_collector_trace_collector_stats_impl;
__attribute__((unused))
static trace_collector_trace_collector_errors_fn _trace_collector_trace_collector_trace_collector_trace_collector_errors_check = trace_collector_trace_collector_errors_impl;
...
struct class_ptr_result trace_collector_trace_collector_class_get(void)
{
    ...
    static const struct op ops[] = {
        ...
        {"trace_collector", "trace_collector_stats", (method_id_t)trace_collector_trace_collector_stats, (impl_t)trace_collector_trace_collector_stats_impl},
        {"trace_collector", "trace_collector_errors", (method_id_t)trace_collector_trace_collector_errors, (impl_t)trace_collector_trace_collector_errors_impl},
    };
    struct class_ptr_result _r =
        class_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                       NULL, NULL, 0);
    if (PICOMESH_IS_ERR(_r))
        return PICOMESH_ERR(class_ptr, "trace_collector_trace_collector_class_get: class_register failed", _r);
    cls = _r.value;
    return _r;
}
