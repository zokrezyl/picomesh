...
struct picomesh_int64_result calculator_calc_add_impl(struct ctx *ctx,
                                                      struct object *obj,
...
struct picomesh_int64_result calculator_calc_sub_impl(struct ctx *ctx,
                                                      struct object *obj,
                                                      struct yheaders *hdrs,
                                                      int64_t x, int64_t y) {
  (void)ctx;
...
struct picomesh_int64_result calculator_calc_mul_impl(struct ctx *ctx,
                                                      struct object *obj,
                                                      struct yheaders *hdrs,
                                                      int64_t x, int64_t y) {
  (void)ctx;
...
struct picomesh_int64_result calculator_calc_div_impl(struct ctx *ctx,
                                                      struct object *obj,
                                                      struct yheaders *hdrs,
                                                      int64_t x, int64_t y) {
  (void)ctx;
