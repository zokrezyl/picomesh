...
portalloc_portalloc_allocate_skel(const void *_body, size_t _body_len,
  ...
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.portalloc_portalloc_allocate");
  struct picomesh_uint32_result _r =
      portalloc_portalloc_allocate(&_local, _obj, _hdrs, _s1, _s2);
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "portalloc_portalloc_allocate_skel: response buffer too small");
...
static struct picomesh_size_result
portalloc_portalloc_release_skel(const void *_body, size_t _body_len,
                                 void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.portalloc_portalloc_release");
  struct picomesh_int_result _r =
      portalloc_portalloc_release(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "portalloc_portalloc_release_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
portalloc_portalloc_count_used_skel(const void *_body, size_t _body_len,
                                    void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.portalloc_portalloc_count_used");
  struct picomesh_size_result _r =
      portalloc_portalloc_count_used(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "portalloc_portalloc_count_used_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
portalloc_portalloc_list_skel(const void *_body, size_t _body_len, void *_resp,
                              size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_json_result _r =
      portalloc_portalloc_list(&_local, _obj, _hdrs, _v1, _v2);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "portalloc_portalloc_list_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
portalloc_portalloc_list_all_skel(const void *_body, size_t _body_len,
                                  void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.portalloc_portalloc_list_all");
  struct picomesh_json_result _r =
      portalloc_portalloc_list_all(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "portalloc_portalloc_list_all_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_void_result portalloc_portalloc_allocate_jinvoke(
  ...
  struct picomesh_uint32_result call_result =
      portalloc_portalloc_allocate(call_ctx, obj, hdrs, arg0, arg1);
    ...
    snprintf(err, err_cap, "%s: %s", "portalloc_portalloc_allocate",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "portalloc_portalloc_allocate",
                        call_result);
  }
...
static struct picomesh_void_result portalloc_portalloc_release_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_int_result call_result =
      portalloc_portalloc_release(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "portalloc_portalloc_release",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "portalloc_portalloc_release",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result portalloc_portalloc_count_used_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_size_result call_result =
      portalloc_portalloc_count_used(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "portalloc_portalloc_count_used",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "portalloc_portalloc_count_used",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result portalloc_portalloc_list_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_json_result call_result =
      portalloc_portalloc_list(call_ctx, obj, hdrs, arg0, arg1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result portalloc_portalloc_list_all_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
      portalloc_portalloc_list_all(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "portalloc_portalloc_list_all",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "portalloc_portalloc_list_all",
                        call_result);
  }
  json_writer_raw(result, call_result.value ? call_result.value : "null");
  free(call_result.value);
...
static struct picomesh_void_result portalloc_portalloc_allocate_minvoke(
  ...
  if (_argc != 2u) {
    snprintf(_err, _err_cap,
             "portalloc_portalloc_allocate: expected 2 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "portalloc_portalloc_allocate: wrong argument count");
  }
  char _v0[4096];
  {
    uint32_t _sz = (uint32_t)sizeof(_v0);
    if (!cmp_read_str(_mr, _v0, &_sz)) {
      snprintf(_err, _err_cap, "service_name: expected str arg (%s)",
               cmp_strerror(_mr));
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_uint32_result call_result =
      portalloc_portalloc_allocate(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result portalloc_portalloc_release_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "portalloc_portalloc_release: expected 1 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "portalloc_portalloc_release: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      portalloc_portalloc_release(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result portalloc_portalloc_count_used_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "portalloc_portalloc_count_used: expected 0 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "portalloc_portalloc_count_used: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
...
static struct picomesh_void_result portalloc_portalloc_list_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 2u) {
    snprintf(_err, _err_cap,
             "portalloc_portalloc_list: expected 2 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "portalloc_portalloc_list: wrong argument count");
  }
  int64_t _v0;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
      portalloc_portalloc_list(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result portalloc_portalloc_list_all_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "portalloc_portalloc_list_all: expected 0 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "portalloc_portalloc_list_all: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
...
struct object_ptr_result portalloc_portalloc_create(struct ctx *ctx) {
  ...
  if (PICOMESH_IS_ERR(_kr))
    return PICOMESH_ERR(
        object_ptr, "portalloc_portalloc_create: class accessor failed", _kr);
...
static jinvoke_fn portalloc_jinvoke_lookup(const char *qname) {
  for (size_t i = 0;
       i < sizeof(portalloc_jinvoke_rows) / sizeof(portalloc_jinvoke_rows[0]);
       ++i)
...
static minvoke_fn portalloc_minvoke_lookup(const char *qname) {
  for (size_t i = 0;
       i < sizeof(portalloc_minvoke_rows) / sizeof(portalloc_minvoke_rows[0]);
       ++i)
...
static const struct jinvoke_param portalloc_portalloc_allocate_params[] = {
    {"service_name", "const char *"}, {"host", "const char *"}};
...
static const struct jinvoke_params *portalloc_params_lookup(const char *qname) {
  for (size_t i = 0;
       i < sizeof(portalloc_params_rows) / sizeof(portalloc_params_rows[0]);
       ++i)
...
static struct class_ptr_result portalloc_accessor_lookup(const char *name) {
  if (strcmp(name, "portalloc_portalloc") == 0)
    return portalloc_portalloc_class_get();
  return PICOMESH_OK(class_ptr, NULL);
}

/* ---- portalloc: slot → skel, name-keyed static data --------------- */

struct portalloc_skel_row {
  const char *name;
  rpc_skel_fn fn;
};
...
static rpc_skel_fn portalloc_skel_lookup(const char *name) {
  ...
  for (size_t i = 0;
       i < sizeof(portalloc_skel_rows) / sizeof(portalloc_skel_rows[0]); ++i)
...
struct picomesh_void_result picomesh_plugin_portalloc_register(void) {
  struct picomesh_void_result _ar =
      class_add_accessor_lookup(portalloc_accessor_lookup);
  ...
  jinvoke_params_add_lookup(portalloc_params_lookup);
  {
    ...
    PICOMESH_RETURN_IF_ERR(
        picomesh_void, reg,
        "portalloc register: prewarm portalloc_portalloc_class_get");
  }
  return PICOMESH_OK_VOID();
}
