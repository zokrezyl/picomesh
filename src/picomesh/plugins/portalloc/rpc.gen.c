                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    ytelemetry_server_span_begin(&_tsp, _hdrs, "skel.portalloc_store_allocate");
    struct picomesh_uint32_result _r = portalloc_store_allocate(&_local, _obj, _hdrs, _v1);
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] portalloc_store_allocate", _r.error);
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    _off += sizeof(_v1);
    struct ytelemetry_span _tsp;
    ytelemetry_server_span_begin(&_tsp, _hdrs, "skel.portalloc_store_release");
    struct picomesh_int_result _r = portalloc_store_release(&_local, _obj, _hdrs, _v1);
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] portalloc_store_release", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    struct ytelemetry_span _tsp;
    ytelemetry_server_span_begin(&_tsp, _hdrs, "skel.portalloc_store_count_used");
    struct picomesh_size_result _r = portalloc_store_count_used(&_local, _obj, _hdrs);
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] portalloc_store_count_used", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
                          ...
                          struct yjson_writer *result, char *err, size_t err_cap)
{
    ...
    struct picomesh_uint32_result call_result = portalloc_store_allocate(call_ctx, obj, hdrs, arg0);
                          ...
                          struct yjson_writer *result, char *err, size_t err_cap)
{
    ...
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    struct picomesh_int_result call_result = portalloc_store_release(call_ctx, obj, hdrs, arg0);
    if (PICOMESH_IS_ERR(call_result)) {
                          ...
                          struct yjson_writer *result, char *err, size_t err_cap)
{
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    struct picomesh_size_result call_result = portalloc_store_count_used(call_ctx, obj, hdrs);
    if (PICOMESH_IS_ERR(call_result)) {
...
struct object_ptr_result portalloc_store_create(struct ctx *ctx)
{
    ...
    if (PICOMESH_IS_ERR(_kr))
        return PICOMESH_ERR(object_ptr, "portalloc_store_create: class accessor failed", _kr);
