...
git_repo_git_repo_make_skel(const void *_body, size_t _body_len, void *_resp,
                            size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  ...
  struct picomesh_uint32_result _r =
      git_repo_git_repo_make(&_local, _obj, _hdrs, _v1, _s2, _s3);
  ...
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_make_skel: response buffer too small");
...
static struct picomesh_size_result
git_repo_git_repo_delete_skel(const void *_body, size_t _body_len, void *_resp,
                              size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_int_result _r =
      git_repo_git_repo_delete(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_delete_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_owner_of_skel(const void *_body, size_t _body_len,
  ...
  struct picomesh_uint32_result _r =
      git_repo_git_repo_owner_of(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_owner_of_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_namespace_of_skel(const void *_body, size_t _body_len,
                                    void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_namespace_of");
  struct picomesh_string_result _r =
      git_repo_git_repo_namespace_of(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_namespace_of_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_count_for_owner_skel(const void *_body, size_t _body_len,
                                       void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_count_for_owner");
  struct picomesh_size_result _r =
      git_repo_git_repo_count_for_owner(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_count_for_owner_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_count_total_skel(const void *_body, size_t _body_len,
                                   void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_count_total");
  struct picomesh_size_result _r =
      git_repo_git_repo_count_total(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_count_total_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_list_for_owner_skel(const void *_body, size_t _body_len,
                                      void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_list_for_owner");
  struct picomesh_string_result _r =
      git_repo_git_repo_list_for_owner(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_list_for_owner_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_list_for_namespace_skel(const void *_body, size_t _body_len,
                                          void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_list_for_namespace");
  struct picomesh_string_result _r =
      git_repo_git_repo_list_for_namespace(&_local, _obj, _hdrs, _s1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_list_for_namespace_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
  ...
  }
  {
    ...
    if (_resp_max < 1 + 4 + (size_t)_svlen) {
      free(_r.value);
      return PICOMESH_ERR(picomesh_size, "git_repo_git_repo_list_for_namespace_"
...
static struct picomesh_size_result
git_repo_git_repo_count_for_namespace_skel(const void *_body, size_t _body_len,
                                           void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_count_for_namespace");
  struct picomesh_size_result _r =
      git_repo_git_repo_count_for_namespace(&_local, _obj, _hdrs, _s1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(picomesh_size, "git_repo_git_repo_count_for_namespace_"
                                       "skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
...
static struct picomesh_size_result
git_repo_git_repo_read_tree_skel(const void *_body, size_t _body_len,
                                 void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_read_tree");
  struct picomesh_string_result _r =
      git_repo_git_repo_read_tree(&_local, _obj, _hdrs, _v1, _s2, _s3);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_read_tree_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_read_file_skel(const void *_body, size_t _body_len,
                                 void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_read_file");
  struct picomesh_string_result _r =
      git_repo_git_repo_read_file(&_local, _obj, _hdrs, _v1, _s2, _s3);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_read_file_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_put_file_skel(const void *_body, size_t _body_len,
                                void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  char _s5[4096];
  {
    ...
    if (_slen >= sizeof(_s5))
      goto _short_body;
    if (_slen)
      memcpy(_s5, (const uint8_t *)_body + _off, _slen);
    _s5[_slen] = 0;
    _off += _slen;
  }
  char _s6[4096];
  {
    ...
    if (_slen >= sizeof(_s6))
      goto _short_body;
    if (_slen)
      memcpy(_s6, (const uint8_t *)_body + _off, _slen);
    _s6[_slen] = 0;
    _off += _slen;
  }
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs, "skel.git_repo_git_repo_put_file");
  struct picomesh_string_result _r = git_repo_git_repo_put_file(
      &_local, _obj, _hdrs, _v1, _s2, _s3, _s4, _s5, _s6);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_put_file_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_is_public_skel(const void *_body, size_t _body_len,
                                 void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_is_public");
  struct picomesh_int_result _r =
      git_repo_git_repo_is_public(&_local, _obj, _hdrs, _v1);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_is_public_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_set_public_skel(const void *_body, size_t _body_len,
                                  void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct ytelemetry_span _tsp;
  ytelemetry_server_span_begin(&_tsp, _hdrs,
                               "skel.git_repo_git_repo_set_public");
  struct picomesh_int_result _r =
      git_repo_git_repo_set_public(&_local, _obj, _hdrs, _v1, _v2);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_set_public_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_list_skel(const void *_body, size_t _body_len, void *_resp,
                            size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_json_result _r =
      git_repo_git_repo_list(&_local, _obj, _hdrs, _v1, _v2);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_list_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_size_result
git_repo_git_repo_list_all_skel(const void *_body, size_t _body_len,
                                void *_resp, size_t _resp_max) {
  size_t _off = 0;
  struct ctx _local = {0};
  /* The framework header section is first on every CALL body — parse
  ...
  struct picomesh_json_result _r =
      git_repo_git_repo_list_all(&_local, _obj, _hdrs);
  ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r),
                      PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
  yheaders_free(_hdrs);
  _hdrs = NULL;
  if (_resp_max < 1)
    return PICOMESH_ERR(
        picomesh_size,
        "git_repo_git_repo_list_all_skel: response buffer too small");
  if (PICOMESH_IS_ERR(_r)) {
    char _errbuf[8192] = {0};
    picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
    const char *_msg =
...
static struct picomesh_void_result git_repo_git_repo_make_jinvoke(
  ...
  struct picomesh_uint32_result call_result =
      git_repo_git_repo_make(call_ctx, obj, hdrs, arg0, arg1, arg2);
...
static struct picomesh_void_result git_repo_git_repo_delete_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_int_result call_result =
      git_repo_git_repo_delete(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_owner_of_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_uint32_result call_result =
      git_repo_git_repo_owner_of(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_owner_of",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_owner_of",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result git_repo_git_repo_namespace_of_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_string_result call_result =
      git_repo_git_repo_namespace_of(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_namespace_of",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_namespace_of",
                        call_result);
  }
...
static struct picomesh_void_result git_repo_git_repo_count_for_owner_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_size_result call_result =
      git_repo_git_repo_count_for_owner(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_count_for_owner",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_count_for_owner",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result git_repo_git_repo_count_total_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
      git_repo_git_repo_count_total(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_count_total",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_count_total",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result git_repo_git_repo_list_for_owner_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_list_for_owner(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_list_for_owner",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_list_for_owner",
                        call_result);
  }
  json_writer_string(result, call_result.value ? call_result.value : "");
  free(call_result.value);
...
static struct picomesh_void_result git_repo_git_repo_list_for_namespace_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_list_for_namespace(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_list_for_namespace",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_list_for_namespace",
                        call_result);
  }
  json_writer_string(result, call_result.value ? call_result.value : "");
  free(call_result.value);
...
git_repo_git_repo_count_for_namespace_jinvoke(struct ctx *ctx,
                                              struct object *obj,
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
      git_repo_git_repo_count_for_namespace(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_count_for_namespace",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_count_for_namespace",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result git_repo_git_repo_read_tree_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_read_tree(call_ctx, obj, hdrs, arg0, arg1, arg2);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_read_tree",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_read_tree",
                        call_result);
  }
  json_writer_string(result, call_result.value ? call_result.value : "");
  free(call_result.value);
...
static struct picomesh_void_result git_repo_git_repo_read_file_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_read_file(call_ctx, obj, hdrs, arg0, arg1, arg2);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_read_file",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_read_file",
                        call_result);
  }
  json_writer_string(result, call_result.value ? call_result.value : "");
  free(call_result.value);
...
static struct picomesh_void_result git_repo_git_repo_put_file_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result = git_repo_git_repo_put_file(
      call_ctx, obj, hdrs, arg0, arg1, arg2, arg3, arg4, arg5);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_put_file",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_put_file",
                        call_result);
  }
  json_writer_string(result, call_result.value ? call_result.value : "");
  free(call_result.value);
...
static struct picomesh_void_result git_repo_git_repo_is_public_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      git_repo_git_repo_is_public(call_ctx, obj, hdrs, arg0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_is_public",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_is_public",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result git_repo_git_repo_set_public_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      git_repo_git_repo_set_public(call_ctx, obj, hdrs, arg0, arg1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_set_public",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_set_public",
                        call_result);
  }
  json_writer_int(result, (int64_t)call_result.value);
  return PICOMESH_OK_VOID();
...
static struct picomesh_void_result git_repo_git_repo_list_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct picomesh_json_result call_result =
      git_repo_git_repo_list(call_ctx, obj, hdrs, arg0, arg1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_list_all_jinvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const struct json_value *args, struct json_writer *result, char *err,
    size_t err_cap) {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
      git_repo_git_repo_list_all(call_ctx, obj, hdrs);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
    snprintf(err, err_cap, "%s: %s", "git_repo_git_repo_list_all",
             chain[0] ? chain
                      : (call_result.error.msg ? call_result.error.msg
                                               : "<no message>"));
    return PICOMESH_ERR(picomesh_void, "git_repo_git_repo_list_all",
                        call_result);
  }
  json_writer_raw(result, call_result.value ? call_result.value : "null");
  free(call_result.value);
...
static struct picomesh_void_result git_repo_git_repo_make_minvoke(
  ...
  if (_argc != 3u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_make: expected 3 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_make: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
    if (!cmp_read_uinteger(_mr, &_u)) {
      snprintf(_err, _err_cap, "owner_id: expected unsigned int (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    if (_u > UINT32_MAX) {
      snprintf(_err, _err_cap, "owner_id: value %llu out of range for uint32_t",
  ...
  char _v1[4096];
  {
    ...
    if (!cmp_read_str(_mr, _v1, &_sz)) {
      snprintf(_err, _err_cap, "owner_name: expected str arg (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
  }
  char _v2[4096];
  {
    ...
    if (!cmp_read_str(_mr, _v2, &_sz)) {
      snprintf(_err, _err_cap, "repo_name: expected str arg (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
  }
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_uint32_result call_result =
      git_repo_git_repo_make(call_ctx, obj, hdrs, _v0, _v1, _v2);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_delete_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_delete: expected 1 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_delete: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      git_repo_git_repo_delete(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_owner_of_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_owner_of: expected 1 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_owner_of: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_uint32_result call_result =
      git_repo_git_repo_owner_of(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_namespace_of_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_namespace_of: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_namespace_of: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_namespace_of(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_count_for_owner_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_count_for_owner: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(
        picomesh_void,
        "git_repo_git_repo_count_for_owner: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
      git_repo_git_repo_count_for_owner(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_count_total_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_count_total: expected 0 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_count_total: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
...
static struct picomesh_void_result git_repo_git_repo_list_for_owner_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_list_for_owner: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(
        picomesh_void,
        "git_repo_git_repo_list_for_owner: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_list_for_owner(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_list_for_namespace_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_list_for_namespace: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(
        picomesh_void,
        "git_repo_git_repo_list_for_namespace: wrong argument count");
  }
  char _v0[4096];
  {
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_list_for_namespace(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result
git_repo_git_repo_count_for_namespace_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_count_for_namespace: expected 1 arg(s), got %u",
             _argc);
    return PICOMESH_ERR(
        picomesh_void,
        "git_repo_git_repo_count_for_namespace: wrong argument count");
  }
  char _v0[4096];
  {
    uint32_t _sz = (uint32_t)sizeof(_v0);
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_size_result call_result =
      git_repo_git_repo_count_for_namespace(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_read_tree_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 3u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_read_tree: expected 3 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_read_tree: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_read_tree(call_ctx, obj, hdrs, _v0, _v1, _v2);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_read_file_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 3u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_read_file: expected 3 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_read_file: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result =
      git_repo_git_repo_read_file(call_ctx, obj, hdrs, _v0, _v1, _v2);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_put_file_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 6u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_put_file: expected 6 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_put_file: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  char _v2[4096];
  {
    uint32_t _sz = (uint32_t)sizeof(_v2);
    if (!cmp_read_str(_mr, _v2, &_sz)) {
      snprintf(_err, _err_cap, "content: expected str arg (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
  }
  char _v3[4096];
  {
    ...
    if (!cmp_read_str(_mr, _v3, &_sz)) {
      snprintf(_err, _err_cap, "message: expected str arg (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
  }
  char _v4[4096];
  {
    ...
    if (!cmp_read_str(_mr, _v4, &_sz)) {
      snprintf(_err, _err_cap, "author_name: expected str arg (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
  }
  char _v5[4096];
  {
    ...
    if (!cmp_read_str(_mr, _v5, &_sz)) {
      snprintf(_err, _err_cap, "author_email: expected str arg (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
  }
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_string_result call_result = git_repo_git_repo_put_file(
      call_ctx, obj, hdrs, _v0, _v1, _v2, _v3, _v4, _v5);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_is_public_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 1u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_is_public: expected 1 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_is_public: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      git_repo_git_repo_is_public(call_ctx, obj, hdrs, _v0);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_set_public_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 2u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_set_public: expected 2 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_set_public: wrong argument count");
  }
  uint32_t _v0;
  {
    uint64_t _u;
  ...
  int _v1;
  {
    ...
    if (!cmp_read_integer(_mr, &_i)) {
      snprintf(_err, _err_cap, "is_public: expected int (%s)",
               cmp_strerror(_mr));
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    if (_i < (INT_MIN) || _i > (INT_MAX)) {
      snprintf(_err, _err_cap, "is_public: value %lld out of range for int",
               (long long)_i);
      return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
    }
    _v1 = (int)_i;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_int_result call_result =
      git_repo_git_repo_set_public(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_list_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 2u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_list: expected 2 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_list: wrong argument count");
  }
  int64_t _v0;
  ...
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
      git_repo_git_repo_list(call_ctx, obj, hdrs, _v0, _v1);
  if (PICOMESH_IS_ERR(call_result)) {
    char chain[8192] = {0};
    picomesh_error_snprint(chain, sizeof(chain), call_result.error);
...
static struct picomesh_void_result git_repo_git_repo_list_all_minvoke(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs, cmp_ctx_t *_mr,
    uint32_t _argc, cmp_ctx_t *_mw, char *_err, size_t _err_cap) {
  (void)_mr;
  if (_argc != 0u) {
    snprintf(_err, _err_cap,
             "git_repo_git_repo_list_all: expected 0 arg(s), got %u", _argc);
    return PICOMESH_ERR(picomesh_void,
                        "git_repo_git_repo_list_all: wrong argument count");
  }
  struct ctx local_ctx = {0};
  struct ctx *call_ctx = ctx ? ctx : &local_ctx;
  struct picomesh_json_result call_result =
...
struct object_ptr_result git_repo_git_repo_create(struct ctx *ctx) {
  ...
  if (PICOMESH_IS_ERR(_kr))
    return PICOMESH_ERR(object_ptr,
                        "git_repo_git_repo_create: class accessor failed", _kr);
...
static const struct git_repo_jinvoke_row git_repo_jinvoke_rows[] = {
    ...
    {"git_repo_git_repo_count_for_owner",
     git_repo_git_repo_count_for_owner_jinvoke},
    {"git_repo_git_repo_count_total", git_repo_git_repo_count_total_jinvoke},
    {"git_repo_git_repo_list_for_owner",
     git_repo_git_repo_list_for_owner_jinvoke},
    {"git_repo_git_repo_list_for_namespace",
     git_repo_git_repo_list_for_namespace_jinvoke},
    {"git_repo_git_repo_count_for_namespace",
     git_repo_git_repo_count_for_namespace_jinvoke},
...
static jinvoke_fn git_repo_jinvoke_lookup(const char *qname) {
  for (size_t i = 0;
       i < sizeof(git_repo_jinvoke_rows) / sizeof(git_repo_jinvoke_rows[0]);
       ++i)
...
static const struct git_repo_minvoke_row git_repo_minvoke_rows[] = {
    ...
    {"git_repo_git_repo_count_for_owner",
     git_repo_git_repo_count_for_owner_minvoke},
    {"git_repo_git_repo_count_total", git_repo_git_repo_count_total_minvoke},
    {"git_repo_git_repo_list_for_owner",
     git_repo_git_repo_list_for_owner_minvoke},
    {"git_repo_git_repo_list_for_namespace",
     git_repo_git_repo_list_for_namespace_minvoke},
    {"git_repo_git_repo_count_for_namespace",
     git_repo_git_repo_count_for_namespace_minvoke},
...
static minvoke_fn git_repo_minvoke_lookup(const char *qname) {
  for (size_t i = 0;
       i < sizeof(git_repo_minvoke_rows) / sizeof(git_repo_minvoke_rows[0]);
       ++i)
...
static const struct jinvoke_param
    git_repo_git_repo_list_for_namespace_params[] = {{"path", "const char *"}};
static const struct jinvoke_param
    git_repo_git_repo_count_for_namespace_params[] = {{"path", "const char *"}};
static const struct jinvoke_param git_repo_git_repo_read_tree_params[] = {
    {"repo_id", "uint32_t"}, {"ref", "const char *"}, {"path", "const char *"}};
...
static const struct jinvoke_param git_repo_git_repo_put_file_params[] = {
    {"repo_id", "uint32_t"},         {"path", "const char *"},
    {"content", "const char *"},     {"message", "const char *"},
    {"author_name", "const char *"}, {"author_email", "const char *"}};
...
static const struct git_repo_params_row git_repo_params_rows[] = {
    ...
    {"git_repo_git_repo_namespace_of",
     {git_repo_git_repo_namespace_of_params, 1}},
    {"git_repo_git_repo_count_for_owner",
     {git_repo_git_repo_count_for_owner_params, 1}},
    {"git_repo_git_repo_count_total", {NULL, 0}},
    {"git_repo_git_repo_list_for_owner",
     {git_repo_git_repo_list_for_owner_params, 1}},
    {"git_repo_git_repo_list_for_namespace",
     {git_repo_git_repo_list_for_namespace_params, 1}},
    {"git_repo_git_repo_count_for_namespace",
     {git_repo_git_repo_count_for_namespace_params, 1}},
...
static struct class_ptr_result git_repo_accessor_lookup(const char *name) {
  if (strcmp(name, "git_repo_git_repo") == 0)
    return git_repo_git_repo_class_get();
  return PICOMESH_OK(class_ptr, NULL);
}

/* ---- git_repo: slot → skel, name-keyed static data --------------- */

struct git_repo_skel_row {
  const char *name;
  rpc_skel_fn fn;
};
...
static const struct git_repo_skel_row git_repo_skel_rows[] = {
    ...
    {"git_repo_git_repo_count_for_owner",
     git_repo_git_repo_count_for_owner_skel},
    ...
    {"git_repo_git_repo_list_for_namespace",
     git_repo_git_repo_list_for_namespace_skel},
    {"git_repo_git_repo_count_for_namespace",
     git_repo_git_repo_count_for_namespace_skel},
...
static rpc_skel_fn git_repo_skel_lookup(const char *name) {
  ...
  for (size_t i = 0;
       i < sizeof(git_repo_skel_rows) / sizeof(git_repo_skel_rows[0]); ++i)
...
struct picomesh_void_result picomesh_plugin_git_repo_register(void) {
  struct picomesh_void_result _ar =
      class_add_accessor_lookup(git_repo_accessor_lookup);
  ...
  jinvoke_params_add_lookup(git_repo_params_lookup);
  {
    ...
    PICOMESH_RETURN_IF_ERR(
        picomesh_void, reg,
        "git_repo register: prewarm git_repo_git_repo_class_get");
  }
  return PICOMESH_OK_VOID();
}
