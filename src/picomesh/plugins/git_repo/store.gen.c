...
static git_repo_git_repo_make_fn _git_repo_git_repo_git_repo_git_repo_make_check = git_repo_git_repo_make_impl;
__attribute__((unused))
static git_repo_git_repo_delete_fn _git_repo_git_repo_git_repo_git_repo_delete_check = git_repo_git_repo_delete_impl;
__attribute__((unused))
...
__attribute__((unused))
static git_repo_git_repo_read_file_fn _git_repo_git_repo_git_repo_git_repo_read_file_check = git_repo_git_repo_read_file_impl;
__attribute__((unused))
static git_repo_git_repo_put_file_fn _git_repo_git_repo_git_repo_git_repo_put_file_check = git_repo_git_repo_put_file_impl;
__attribute__((unused))
static git_repo_git_repo_is_public_fn _git_repo_git_repo_git_repo_git_repo_is_public_check = git_repo_git_repo_is_public_impl;
__attribute__((unused))
static git_repo_git_repo_set_public_fn _git_repo_git_repo_git_repo_git_repo_set_public_check = git_repo_git_repo_set_public_impl;
__attribute__((unused))
static git_repo_git_repo_list_fn _git_repo_git_repo_git_repo_git_repo_list_check = git_repo_git_repo_list_impl;
__attribute__((unused))
static git_repo_git_repo_list_all_fn _git_repo_git_repo_git_repo_git_repo_list_all_check = git_repo_git_repo_list_all_impl;
...
struct class_ptr_result git_repo_git_repo_class_get(void)
{
    ...
    static const struct op ops[] = {
        ...
        {"git_repo", "git_repo_is_public", (method_id_t)git_repo_git_repo_is_public, (impl_t)git_repo_git_repo_is_public_impl},
        {"git_repo", "git_repo_set_public", (method_id_t)git_repo_git_repo_set_public, (impl_t)git_repo_git_repo_set_public_impl},
        {"git_repo", "git_repo_list", (method_id_t)git_repo_git_repo_list, (impl_t)git_repo_git_repo_list_impl},
        {"git_repo", "git_repo_list_all", (method_id_t)git_repo_git_repo_list_all, (impl_t)git_repo_git_repo_list_all_impl},
    };
    struct class_ptr_result _r =
        class_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                       NULL, NULL, 0);
    if (PICOMESH_IS_ERR(_r))
        return PICOMESH_ERR(class_ptr, "git_repo_git_repo_class_get: class_register failed", _r);
    cls = _r.value;
    return _r;
}
