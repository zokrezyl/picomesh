#!/usr/bin/env bash
# Run the mesh-up.sh assertion battery against the riscv64 picomesh
# running inside qemu, reached over the slirp hostfwd at
# 127.0.0.1:18080. Same shape as scenarios/picoforge/mesh-up.sh
...
SMP=2 MEM=512M bash "$REPO/scenarios/picoforge/yemu/run-vm.sh" -snapshot \
